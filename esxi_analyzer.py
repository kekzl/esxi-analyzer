...
def main():
    ...
    parser = argparse.ArgumentParser(description='ESXi Issue Analyzer - Diagnose and suggest solutions for ESXi problems')
    ...
    parser.add_argument('-d', '--directory', required=False, help='Directory containing ESXi logs (if already collected)')
